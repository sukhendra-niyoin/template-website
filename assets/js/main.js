...
!(function (p) {
    ...
    (p.fn.myOwl = function (e) {
        ...
        (p.fn.instaFeed = function (e) {
            var i = p.extend({ token: "", $this: p(this), photos: 0 }, e);
            p.ajax({
                url: "https://api.instagram.com/v1/users/self/media/recent",
                dataType: "jsonp",
                type: "GET",
                data: { access_token: i.token, count: i.photos },
                success: function (e) {
                    for (var t in e.data)
                        i.$this.append(
                            '<li><a href="' +
    ...
    if (
        ((p.fn.scrollView = function () {
            return this.each(function () {
                p("html, body").animate({ scrollTop: p(this).offset().top }, 1e3);
            });
        }),
            ...
            (p.fn.mySelect = function (e) {
                ...
                for (
                    var o = p("<ul />", { class: "select-options" }).insertAfter(a), n = 0;
                    n < i.length;
                    n++
                )
                    p("<li />", {
                ...
                a.on("click", function (e) {
                    e.stopPropagation(),
                        ...
                        p(this).toggleClass("active").next(".select-options").toggle(),
                        p(this).parent().toggleClass("focus");
                }),
                    s.on("click", function (e) {
                        e.stopPropagation(),
                            ...
                            o.hide(),
                            p(this).parent().parent().hasClass("focus") &&
                            p(this).parent().parent().removeClass("focus");
                    }),
            ...
            (p.fn.customNumber = function (e) {
                var t = p.extend({ plusIcon: "", minusIcon: "" }, e);
                return (
            ...
            (p.fn.onScreen = function () {
                var e = this.offset(),
                    t =
                        (p(window),
                            { top: p(window).scrollTop(), left: p(window).scrollLeft() });
                return (
                ...
                if ((m(), y(), h(), v(), g(), 0 < p(".cases-grid, .blog-grid").length)) {
                    ...
                    (r = function () {
                        n.isotope({
                            ...
                            masonry: { columnWidth: e(), gutterWidth: 3 },
                        });
                    })(),
                ...
                0 < p(".agency-portfolio-slider").length &&
                    p(".agency-portfolio-slider").myOwl({
                        ...
                        responsive: {
                            ...
                            480: { items: 1, autoWidth: !1 },
                            768: { items: 2, autoWidth: !1 },
                            1024: { items: 5, autoWidth: !0 },
                        },
                    });
            }),
            p(document).ready(function () {
                ...
                m(),
                    ...
                    g(),
                    0 < p(".xs-menus").length &&
                    p(".xs-menus").xs_nav({ mobileBreakpoint: 992 }),
                    0 < p(".xs-hidden-menus").length &&
                    (p(".xs-hidden-menus").xs_nav({ hidden: !0, offCanvasSide: "right" }),
                    ...
                    p(".agency-office-slider").myOwl({
                        ...
                        responsive: {
                            0: { items: 1, autoWidth: !1, nav: !1, margin: 0 },
                            480: { items: 1, autoWidth: !1, nav: !1, margin: 0 },
                            768: { items: 2, autoWidth: !1, nav: !1 },
                            1024: { items: 3, autoWidth: !0, nav: !0 },
                        },
                    }),
                    ...
                    p(".agency-single-team").hover(function () {
                        p(this).parent().hasClass("hover")
                            ? p(this).parent().removeClass("hover")
                            : p(this).parent().addClass("hover");
                    }),
                    (function () {
                        for (
                            ...
                            p(i[o]).myGradientChart({ barColor1: e[o], barColor2: t[o] });
                ...
                if (0 < p(".waypoint-tigger").length)
                    new Waypoint({
                        element: document.getElementsByClassName("waypoint-tigger"),
                        handler: function (e) {
                            i.each(function () {
                                p(this).animateNumbers(
                                    p(this).attr("data-value"),
                                    !0,
                                    parseInt(p(this).attr("data-animation-duration"), 10)
                                );
                                var e = p(this).attr("data-value");
                                p(this)
                                    .closest(".single-skill-bar")
                                    .find(".skill-track")
                                    .animate({ width: e + "%" }, 3500);
                            });
                        },
                        offset: "50%",
                    });
                ...
                if (
                    (p(".nav-menu li a").each(function (e, t) {
                        ...
                        0 < p(".xs-image-popup").length &&
                        p(".xs-image-popup").magnificPopup({
                            type: "image",
                            removalDelay: 500,
                            callbacks: {
                                beforeOpen: function () {
                        ...
                        0 < p(".post-gallery-slider").length &&
                        p(".post-gallery-slider").myOwl({
                            nav: !0,
                            navText: [
                                '<i class="icon icon-left-arrows" />',
                        ...
                        0 < p(".parallax-service").length)
                )
                    new Swiper(".parallax-service", {
                        direction: "vertical",
                        slidesPerView: 1,
                        mousewheel: { invert: !0, releaseOnEdges: !0, forceToAxis: !0 },
                ...
                (0 < p(".xs-select").length && p(".xs-select").mySelect(),
                    ...
                    p(".product-slider, .about-slider").myOwl({
                        dots: !0,
                        responsive: { 0: { dots: !1 }, 768: { dots: !0 } },
                    }),
                    ...
                    (p(".floating-icons-list").addClass("hidden"),
                        p(".btn-floating").each(function () {
                            p(this).on("click", function (e) {
                                e.preventDefault(),
                                    p(this).next().toggleClass("open"),
                                    p(this).next().toggleClass("hidden"),
                ...
                if (
                    (0 < p(".rate-graph").length &&
                        p(".rate-graph").each(function () {
                            p(this).find(".rate-graph-bar").attr("data-percent") <= 100
                                ? p(this)
                                    .find(".rate-graph-bar")
                                    .css({
                                        width:
                                            p(this).find(".rate-graph-bar").attr("data-percent") +
                                            "%",
                                    })
                                : p(this).find(".rate-graph-bar").css({ width: "100%" });
                        }),
                    ...
                    n
                        ...
                        .on("changed.owl.carousel", function (e) {
                            ...
                            s.find(".owl-item.active").last().index() < i &&
                                s.data("owl.carousel").to(i, 100, !0),
                        ...
                        (p(".single-page-menu li a").on("click", function () {
                            if (
                                ...
                                if (
                                    ...
                                    return (
                                        p("html,body").animate({ scrollTop: e.offset().top }, 1e3), !1
                                    );
                            }
                        }),
                            p(".single-page-menu li a").on("click", function () {
                ...
                if (
                    (p("body").on("click", ".fullscreen_menu_tigger", function (e) {
                        ...
                        p(".offcanvas-menu .inner-submenu").prev("a").hasClass("tigger")
                            ? p(".offcanvas-menu .inner-submenu").prev().removeClass("tigger")
                            : p(".offcanvas-menu .inner-submenu").prev().addClass("tigger"),
                        p(".offcanvas-menu li .tigger").on("click", function (e) {
                            e.preventDefault(),
                                p(this).next().hasClass("show")
                                    ? (p(this).next().removeClass("show"),
                                        p(this).next().slideUp(500),
                                        p(this).removeClass("active"))
                                    : (p(this).next().addClass("show"),
                                        p(this)
                                            .parent()
                                            .parent()
                                            .find(".offcanvas-menu li ul")
                                            .removeClass("show"),
                                        p(this)
                                            .parent()
                                            .parent()
                                            .find(".offcanvas-menu li ul")
                                            .slideUp(400),
                                        p(this).next().slideToggle(500),
                                        p(this).addClass("active"));
                        }),
                        (function () {
                            function e() {
                                void 0 === u && (u = jQuery),
                                    null == u("#rev_slider_8_1").revolution
                        ...
                        (function () {
                            function e() {
                                void 0 === u && (u = jQuery),
                                    null == u("#rev_slider_15_1").revolution
                        ...
                        (function () {
                            function e() {
                                void 0 === u && (u = jQuery),
                                    null == u("#rev_slider_16_1").revolution
                        ...
                        0 < p(".service-boxed").length &&
                        (p(".service-boxed").on("mouseenter", function () {
                    ...
                    f.myOwl({
                        ...
                        f.on("mousewheel", ".owl-stage", function (e) {
                            0 < e.deltaY ? f.trigger("next.owl") : f.trigger("prev.owl"),
                                e.preventDefault();
                        });
                }
                p(document).on("click", ".backtotop", function (e) {
                    e.preventDefault(),
                        p("body, html").stop().animate({ scrollTop: 0 }, 1e3);
                });
            }),
            p(window).on("scroll", function () {
                0 < p(".shuffle-letter-title-wraper").length &&
                    p(".shuffle-letter-title-wraper").each(function (e) {
                        p(this).onScreen() &&
                            ...
                            setTimeout(
                                function () {
                                    p(this).find(".shuufle-letter-title").shuffleLetters(),
